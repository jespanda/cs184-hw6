#ifndef __GLM_MODEL_LOADER__
#define __GLM_MODEL_LOADER__
...
EXTERN GLvoid glmDraw(GLMmodel* model, GLuint mode,char *drawonly);

EXTERN GLfloat glmDot(GLfloat* u, GLfloat* v);
...
EXTERN GLMmodel* glmReadOBJ(const char* filename);
EXTERN GLMmodel* glmReadOBJ(const char* filename,mycallback *call);
